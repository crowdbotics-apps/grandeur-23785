"""grandeur_23785 URL Configuration
...
admin.site.site_header = "Grandeur"
admin.site.site_title = "Grandeur Admin Portal"
admin.site.index_title = "Grandeur Admin"

# swagger
api_info = openapi.Info(
    title="Grandeur API",
    default_version="v1",
    description="API documentation for Grandeur App",
)
